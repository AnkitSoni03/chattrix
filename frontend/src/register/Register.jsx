            ...
            <div className='w-full max-w-lg mx-4'>
                <div className='bg-gradient-to-br from-gray-900 to-gray-800 bg-opacity-90 backdrop-blur-lg rounded-2xl shadow-2xl p-6 border border-gray-700'>
                    ...
                    <h1 className='text-3xl font-bold text-center mb-6'>
                        ...
                        <span className='text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-teal-400'> Chattrix</span>
                    </h1>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex gap-8 justify-center">
                                <label className="flex items-center gap-2 cursor-pointer group">
                                    ...
                                    />
                                    <span className="text-gray-200 text-sm group-hover:text-emerald-400 transition-colors">Male</span>
                                </label>
                                <label className="flex items-center gap-2 cursor-pointer group">
                                    <input 
                                        checked={inputData.gender === 'female'}
                                        ...
                                        className="w-4 h-4 text-emerald-600 bg-gray-800 border-2 border-gray-600 rounded focus:ring-emerald-500"
                                    />
                                    <span className="text-gray-200 text-sm group-hover:text-emerald-400 transition-colors">Female</span>
                                </label>
                            </div>
                        </div>
